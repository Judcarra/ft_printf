...
SRCS = $(SRCS_DIR)/ft_print_char.c $(SRCS_DIR)/ft_print_str.c $(SRCS_DIR)/ft_print_nbr.c $(SRCS_DIR)/ft_print_unsigned.c $(SRCS_DIR)/ft_hexa_minus.c $(SRCS_DIR)/ft_hexa_mayus.c
